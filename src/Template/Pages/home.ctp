...
<div id="page-content">
    ...
    <section id="profile" class="black">
        ...
        <!-- Background photo -->
        <div id="profile-bg" class="editable-alpha" data-alpha="40"><?= $this->Html->image('backgrounds/profile-bg.jpg') ?></div>
        ...
        <div class="content padded dark">
            ...
            <div class="profile-content">
                <h1 class="short">Johnatan Doe</h1>
                <h5>I am <span class="text-primary">proffessional</span> webdesigner & webdeveloper.</h5>
                <a href="http://themeforest.net/item/me-responsive-bootstrap-3-vcard-htmlcss-theme/7800423?WT.ac=portfolio&WT.z_author=suelo" class="btn btn-primary" target="_blank">Buy this theme!</a> <a href="#contact" class="btn btn-default">Contact me</a>
            </div>
            ...
            <div class="bottom-bar profile-bottom-bar hidden-xs">
                ...
                <ul class="list-inline">
                    <li><i class="inline-icon icon-before-and-after text-primary fa fa-map-marker"></i>1111-A Nowhere Lane, Outta Sight, State 90378, USA</li>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="resume-box animated slide-in-left appear-second">
                        ...
                        <!-- Sinlge skill -->
                        <div class="skill">
                            <span class="skill-name">Adobe Dreamweaver</span>
                            <div class="skill-bar sb-green">
                                <div class="skill-rate-on"></div>
                                <div class="skill-rate-on"></div>
        ...
        <div class="projects-holder black dark clearfix">
            ...
            <div class="single-project animated fade-in">
                <div class="project-image">
                    <?= $this->Html->image('portfolio/project_01.jpg') ?>
                </div>
            ...
            <div class="single-project animated fade-in appear-third">
                <div class="project-image">
                    <?= $this->Html->image('portfolio/project_02.jpg') ?>
                </div>
                <div class="project-mask">
                    <div class="project-info">
            ...
            <div class="single-project animated fade-in appear-second">
                <div class="project-image">
                    <?= $this->Html->image('portfolio/project_03.jpg') ?>
                </div>
                <div class="project-mask">
                    <div class="project-info">
            ...
            <div class="single-project animated fade-in appear-fourth">
                <div class="project-image">
                    <?= $this->Html->image('portfolio/project_04.jpg') ?>
                </div>
                <div class="project-mask">
                    <div class="project-info">
            ...
            <div class="single-project animated fade-in">
                <div class="project-image">
                    <?= $this->Html->image('portfolio/project_05.jpg') ?>
                </div>
                <div class="project-mask">
                    <div class="project-info">
            ...
            <div class="single-project animated fade-in appear-second">
                <div class="project-image">
                    <?= $this->Html->image('portfolio/project_06.jpg') ?>
                </div>
                <div class="project-mask">
                    <div class="project-info">
            ...
            <div class="single-project animated fade-in appear-fourth">
                <div class="project-image">
                    <?= $this->Html->image('portfolio/project_07.jpg') ?>
                </div>
                <div class="project-mask">
                    <div class="project-info">
            ...
            <div class="single-project animated fade-in appear-third">
                <div class="project-image">
                    <?= $this->Html->image('portfolio/project_08.jpg') ?>
                </div>
                <div class="project-mask">
                    <div class="project-info">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="post-carousel animated slide-in-top">
                        ...
                        <article class="post post-carousel-item">
                            <div class="post-image"><?= $this->Html->image('blog/post_01.jpg') ?></div>
                        ...
                        <!-- Single Post -->
                        <article class="post post-carousel-item">
                            <div class="post-image"><?= $this->Html->image('blog/post_02.jpg') ?></div>
                            <div class="post-content-holder">
                                <div class="post-content">
                                    <div class="post-info clearfix">
                                        <span class="post-date">22 May, 2014</span>
                                    ...
                                    <div class="post-text">
                                        <h3><a href="single-post.html">Brand New PC</a></h3>
                                        <p class="lead">Per sint eirmod expetenda te. Pro ne essent.</p>
                                        <p>Per ea tibique fabellas electram. Ea aliquam corpora vis. Ne quot civibus atomorum quo. </p>
                                        <a href="single-post.html" class="btn btn-primary btn-sm">Read more</a>
                                    </div>
                        ...
                        <!-- Single Post -->
                        <article class="post post-carousel-item">
                            <div class="post-image"><?= $this->Html->image('blog/post_03.jpg') ?></div>
                            <div class="post-content-holder">
                                <div class="post-content">
                                    <div class="post-info clearfix">
                                        <span class="post-date">22 May, 2014</span>
                                    ...
                                    <div class="post-text">
                                        <h3><a href="single-post.html">To be or not to be?</a></h3>
                                        <p class="lead">Per sint eirmod expetenda te. Pro ne essent.</p>
                                        <p>Per ea tibique fabellas electram. Ea aliquam corpora vis. Ne quot civibus atomorum quo. </p>
                                        <a href="single-post.html" class="btn btn-primary btn-sm">Read more</a>
                                    </div>
                        ...
                        <!-- Single Post -->
                        <article class="post post-carousel-item">
                            <div class="post-image"><?= $this->Html->image('blog/post_04.jpg') ?></div>
                            <div class="post-content-holder">
                                <div class="post-content">
                                    <div class="post-info clearfix">
                                        <span class="post-date">22 May, 2014</span>
                                    ...
                                    <div class="post-text">
                                        <h3><a href="single-post.html">New Software for my company</a></h3>
                                        <p class="lead">Per sint eirmod expetenda te. Pro ne essent.</p>
                                        <p>Per ea tibique fabellas electram. Ea aliquam corpora vis. Ne quot civibus atomorum quo. </p>
                                        <a href="single-post.html" class="btn btn-primary btn-sm">Read more</a>
                                    </div>
                        ...
                        <!-- Single Post -->
                        <article class="post post-carousel-item">
                            <div class="post-image"><?= $this->Html->image('blog/post_05.jpg') ?></div>
                            <div class="post-content-holder">
                                <div class="post-content">
                                    <div class="post-info clearfix">
                                        <span class="post-date">22 May, 2014</span>
                        ...
                        <!-- Single Post -->
                        <article class="post post-carousel-item">
                            <div class="post-image"><?= $this->Html->image('blog/post_06.jpg') ?></div>
                            <div class="post-content-holder">
                                <div class="post-content">
                                    <div class="post-info clearfix">
                                        <span class="post-date">22 May, 2014</span>
                        ...
                        <!-- Single Post -->
                        <article class="post post-carousel-item">
                            <div class="post-image"><?= $this->Html->image('blog/post_07.jpg') ?></div>
                            <div class="post-content-holder">
                                <div class="post-content">
                                    <div class="post-info clearfix">
                                        <span class="post-date">22 May, 2014</span>
